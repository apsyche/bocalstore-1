	...
	save=function(resId,posId,pcId){
		...
		$.ajax({
			   ...
			   success: function(data){
				   location.href = "!urb!index!urbPermisRegul!index!"+resId+"!"+posId+"!"+data;
			   },
			...
			"Enregistrer": function(){ 
				...
				$.ajax({
					...
					success: function(data){
					 ...
					 location.href = "!urb!index!urbPermisRegul!index!"+resId+"!"+posId+"!"+pcId;
					 },
					   error:function(xhr, ajaxOptions, thrownError){
...
printPc=function(pid){
	...
	location.href = "urbPdf!index!permisConstRegul!" + pid;
}
