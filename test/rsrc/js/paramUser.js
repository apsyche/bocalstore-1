$(function() {
	...
	editUser=function(mode,usrId,lname,fname,login,mail,usr_right_four,usr_right_mat,usr_right_inv,usr_right_pret,usr_right_ged,usr_right_param){
		if(mode == 'E'){
			$("#usr_id").val(usrId);
			$("#usr_lname").val(lname);
			$("#usr_fname").val(fname);
			...
			(usr_right_mat == '1')		? $("#usr_right_mat").attr('checked', true):$("#usr_right_mat").attr('checked', false) ;
		...
		if(mode == 'N'){
			...
			$("#usr_right_mat").attr('checked', false) ;
				...
				"Enregistrer": function(){ 
					...
					$.ajax({
						   ...
						   data: {
							   ...
							   usr_right_mat   : $("#usr_right_mat").attr("checked"),
