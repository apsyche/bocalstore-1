	...
	save=function(resId,posId,pcId){
		...
		$.ajax({
			   ...
			   success: function(data){
				   location.href = "!urb!index!urbPermisDemol!index!"+resId+"!"+posId+"!"+data;
			   },
			...
			"Enregistrer": function(){ 
				...
				$.ajax({
					...
					success: function(data){
					 ...
					 location.href = "!urb!index!urbPermisDemol!index!"+resId+"!"+posId+"!"+pcId;
					 },
					   error:function(xhr, ajaxOptions, thrownError){
...
printPc=function(pid){
	if(pid == ''){
		alert("Rien a imprimer, Aucun Permis de Démolir Sélectionné !");
		return;
	}
	location.href = "urbPdf!index!permisConstDemolir!" + pid;
}

printDoc=function(pid){

	location.href = "urbPdf!index!printPermisDemolDoc!";
}
