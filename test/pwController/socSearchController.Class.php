<?php
class socSearchController extends PwController {
	...
	public function actionSearch() {
		$soc_nom = (isset($_POST['soc_nom']))?$_POST['soc_nom']:"";
		$soc_prenom = (isset($_POST['soc_prenom']))?$_POST['soc_prenom']:"";
		...
		$list = array();
		if($tSearch == 1){
			$list = Pwsocident::getListSearchPersPh($soc_nom,$soc_prenom,$date);
		}
		if($tSearch == 2){
			$list = Pwsocident::getListSearchPersMor($soc_nom,$soc_prenom,$date);
		}
