...
class paramInfoController extends PwController {
	...
	public function actionSave(){
		...
		$obj->inf_willaya = $_POST['inf_willaya'];
		$obj->inf_daira = $_POST['inf_daira'];
		$obj->inf_commune = $_POST['inf_commune'];
		$obj->inf_imp_titre = $_POST['inf_imp_titre'];
		$obj->inf_nom_maire = $_POST['inf_nom_maire'];
		$obj->inf_prenom_maire = $_POST['inf_prenom_maire'];
