...
<div class="" style="width: 95%">
	...
	<table class="table table-hover table-bordered ">
		<tr style="height: 100px">
			...
			<th><p class="verticalText"> Matériel </p></th>
		...
		<tr>
			...
			<td>{if $row.usr_right_mat} <span class="glyphicon glyphicon-ok-sign" ></span> {/if}</td>
			...
			<td style="width: 100px">
 			<a class="btn btn-default btn-sm" onclick="editUser('E','{$row.usr_id}','{$row.usr_lname|pwAddslashes}','{$row.usr_fname|pwAddslashes}','{$row.usr_login}',
 																'{$row.usr_mail|pwAddslashes}','{$row.usr_right_four}','{$row.usr_right_mat}','{$row.usr_right_inv}','{$row.usr_right_pret}'
	...
	<form action="POST" action="#" id="formUser" name="formUser">
		...
		<table style="width: 95%">
			<tr>
				...
				<td align="right" style="width: 40%">Matériel&nbsp;&nbsp;&nbsp;</td>
				<td> <input  id="usr_right_mat" name="usr_right_mat" class="form-control" type="checkbox" value="1"></label></td>
			</tr>
			<tr>
				...
				<td align="right" style="width: 40%">Prêt&nbsp;&nbsp;&nbsp;</td>
