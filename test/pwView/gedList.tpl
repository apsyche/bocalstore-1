...
<div title="Document" id="addDocDialog"	style="display: none; background-color: #f7f7f9">
	...
	<form action="POST" action="#" id="gedd_file_form" name="gedd_file_form" enctype="multipart/form-data">
		<input type="hidden" name="MAX_FILE_SIZE" value="250000" /> 
		<table style="width: 95%">
			<tr>
				<td align="right" style="width: 40%">Type &nbsp;&nbsp; &nbsp;</td>
				<td>{html_options class="form-control" id='gedd_type' name='gedd_type' options=$listTypeDoc}</td>
			</tr>

			<tr>
				<td align="right" style="width: 40%">Nom Document &nbsp;&nbsp; &nbsp;</td>
				<td><input class="form-control" type="text" id="gedd_nom" name="gedd_nom"></td>
			</tr>
			<tr>
				<td align="right" style="width: 40%">Description &nbsp;&nbsp; &nbsp;</td>
				<td><input class="form-control" type="text" id="gedd_description" name="gedd_description"></td>
			</tr>
			<tr>
