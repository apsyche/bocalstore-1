<h4>
	<span class="glyphicon glyphicon-arrow-right"></span> Recherche
	Documents
</h4>
	...
	<div class="btn-group" role="group">
		<button type="button" class="btn btn-default" onclick="search();">
			<span class="glyphicon glyphicon-search" aria-hidden="true"
				style="color: #428bca;"></span> &nbsp; Recherche
		</button>
	</div>
...
<div style="width: 100%">
	...
	<fieldset class="pwFieldset">
		...
		<div class="row">
			...
			<div class="col-md-4">
				Nom <input class="form-control" type="text" id="name"
					name="gedd_nom">
			</div>
			<div class="col-md-4">
				Description <input style="width: 97%" class="form-control"
					type="text" id="desc" name="gedd_nom">
			</div>
		</div>
