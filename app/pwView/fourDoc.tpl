	...
	<fieldset class="pwFieldset couleurfs">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="">
					<label for="pos_tem1_nom" style="width: 30%">Site Internet
					</label>{$row.fur_site_internet}
				</div>
			</div>
			...
			<div class="col-md-4">
				...
				<div class="">
					<label for="pos_tem1_nom" style="width: 30%">Correspindant
					</label>{$row.fur_nom_corresp} {$row.fur_prenom_corresp}
				</div>
			</div>
		</div>
	</fieldset>
...
<div title="Document" id="addDocDialog"
	...
	<form action="POST" action="#" id="fdoc_file_form"
		name="fdoc_file_form" enctype="multipart/form-data">
		<input type="hidden" name="MAX_FILE_SIZE" value="250000" /> <input
			type="hidden" id="fdoc_fur_id" name="fdoc_fur_id"
			value="{$row.fur_id}">
		<table style="width: 95%">
			<tr>
				<td align="right" style="width: 40%">Type &nbsp;&nbsp; &nbsp;</td>
				<td>{html_options class="form-control" id='fdoc_type'
					name='fdoc_type' options=$listTypeDoc}</td>
			</tr>

			<tr>
				<td align="right" style="width: 40%">Nom Document &nbsp;&nbsp;
					&nbsp;</td>
				<td><input class="form-control" type="text" id="fdoc_nom"
					name="fdoc_nom"></td>
			</tr>
			<tr>
				...
				<td><input class="form-control" type="text"
					id="fdoc_description" name="fdoc_description"></td>
			</tr>
			<tr>
